(function () {
    ...
    var PACMAN_SPEED = 3, PACMAN_RADIUS = 0.25;
    var GHOST_SPEED = 0.5, GHOST_RADIUS = PACMAN_RADIUS * 1.25;
    ...
    var main = function () {
        ...
        var update = function (delta, now) {
            ...
            // Spawn a ghost every 2 seconds, up to 27 sssssssss.
            if (numGhosts < 27 && now - ghostSpawnTime > 2) {
