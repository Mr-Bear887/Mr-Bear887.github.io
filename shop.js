...
function buyAd() {
 if (userMoney < adCost) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have" + adCost +
   "presents.");
...
function buyShelves() {
 if (userMoney < 10000000) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have 10000000 presents."
  );
 ...
 document.getElementById("shelves")
  .innerHTML = "";
 document.getElementById("shelvesPrice")
  .innerHTML = "Already bought";
 checkOpenStatus();
}
//cashregister
function buyCashregister() {
 if (userMoney < 15000000) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have 15000000 presents."
  );
 ...
 if (cashregister) {
  alert(
   "You already have cash register!");
  return;
 }
 cashregister = true;
...
function buyFloors() {
 if (userMoney < 20000000) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have 20000000 presents."
  );
 ...
 document.getElementById("floors")
  .innerHTML = "";
 document.getElementById("floorsPrice")
  .innerHTML = "Already bought";
 checkOpenStatus();
}
//walls
function buyWalls() {
 if (userMoney < 25000000) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have 25000000 presents."
  );
 ...
 document.getElementById("walls")
  .innerHTML = "";
 document.getElementById("wallsPrice")
  .innerHTML = "Already bought";
 checkOpenStatus();
}
//windows
function buyWindows() {
 if (userMoney < 30000000) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have 30000000 presents."
  );
 ...
 document.getElementById("windows")
  .innerHTML = "";
 document.getElementById("windowsPrice")
  .innerHTML = "Already bought";
 checkOpenStatus();
}
//roof
function buyRoof() {
 if (userMoney < 35000000) {
  alert(
   "You don't have enough presentts! You have only" +
   userMoney +
   "presents! You must have 35000000 presentts."
  );
 ...
 document.getElementById("roof")
  .innerHTML = "";
 document.getElementById("roofPrice")
  .innerHTML = "Already bought";
 checkOpenStatus();
}
//stock
function buyStock() {
 if (userMoney < 40000000) {
  alert(
   "You don't have enough presentts! You have only" +
   userMoney +
   "presents! You must have 40000000 presents."
  );
...
function buyTransport() {
 if (userMoney < 45000000) {
  alert(
   "You don't have enough presents! You have only" +
   userMoney +
   "presents! You must have 45000000 presents."
  );
...
function openShop() {
 ...
 if (userMoney < 100000000) {
  alert(
   "You don't have enought presents to open shop!"
  );
  return;
 }
 document.getElementById("shopStatus")
