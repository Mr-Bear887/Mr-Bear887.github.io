function GameSound() {
  ...
  this.init = function() {
    ...
    powerUpAppear = new Audio('power-up-appear.wav');
    powerUp = new Audio('power-up.wav');
    marioDie = new Audio('mario-die.wav');
    killEnemy = new Audio('kill-enemy.wav');
    stageClear = new Audio('stage-clear.wav');
    bullet = new Audio('bullet.wav');
    powerDown = new Audio('power-down.wav');
